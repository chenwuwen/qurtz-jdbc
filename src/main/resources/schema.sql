...
--
-- 在HsqlDb中是有schema的概念的,但是这里设置会报错
-- drop schema KANYUN IF EXISTS ;
-- create schema KANYUN ;
-- set schema KANYUN ;

-- Qurtz表开始
-- 不同数据库的SQL脚本不同,具体查看链接：https://github.com/quartz-scheduler/quartz/blob/quartz-2.0.x/docs/dbTables/
