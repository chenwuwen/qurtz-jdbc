...
INSERT INTO USER (USER_NAME,PASSWORD,AGE,AREA,PHONE,REGISTER_DATE,REGISTER_IP,STATUS) VALUES ('kanyun','123456',27,'北京市',17127290867,unix_timestamp(NOW()),11111,1);
INSERT INTO USER (USER_NAME,PASSWORD,AGE,AREA,PHONE,REGISTER_DATE,REGISTER_IP,STATUS) VALUES ('chenwuwen','123456',28,'郑州市',19965412404,unix_timestamp(NOW()),11111,1);
