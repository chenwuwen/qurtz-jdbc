...
public interface TaskService {
    ...
    /**
     * 添加一个任务
     * 其实际是调用QuartzService来进行任务添加
     * @return
     */
    void insertJob(JobEntity entity) throws ClassNotFoundException, InstantiationException, SchedulerException, IllegalAccessException;
}
